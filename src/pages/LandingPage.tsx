...
const LandingPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans selection:bg-indigo-100 selection:text-indigo-900">
      {/* Navigation */}
      <nav className="flex justify-between items-center gap-3 px-4 sm:px-6 md:px-12 py-4 sm:py-6 bg-white/80 backdrop-blur-md sticky top-0 z-50 border-b border-slate-100">
        ...
        <div className="flex gap-4">
          ...
          <Link to="/login" className="whitespace-nowrap px-4 sm:px-6 py-2.5 bg-indigo-600 text-white font-bold rounded-xl shadow-lg shadow-indigo-200 hover:bg-indigo-700 hover:-translate-y-0.5 transition text-sm">Get Started</Link>
        </div>
      </nav>

      {/* Hero Section */}
      <section className="px-4 sm:px-6 md:px-12 py-14 sm:py-24 text-center max-w-5xl mx-auto">
        ...
        <h1 className="text-4xl sm:text-5xl md:text-7xl font-black tracking-tight leading-[1.1] mb-8 text-slate-900">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-left">
          <div className="p-6 sm:p-10 bg-white rounded-[2rem] shadow-xl shadow-slate-100 border border-slate-100 hover:border-indigo-100 transition duration-300">
          ...
          <div className="p-6 sm:p-10 bg-white rounded-[2rem] shadow-xl shadow-slate-100 border border-slate-100 hover:border-emerald-100 transition duration-300">
          ...
          <div className="p-6 sm:p-10 bg-white rounded-[2rem] shadow-xl shadow-slate-100 border border-slate-100 hover:border-purple-100 transition duration-300">
